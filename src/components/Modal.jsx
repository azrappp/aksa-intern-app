          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              ...
              className={clsx(
                ...
                "bg-white text-slate-900", // Default light mode styles
                "dark:bg-slate-800 dark:text-slate-100", // Dark mode styles
                "duration-150 ease-out data-[closed]:transform-[scale(95%)] data-[closed]:opacity-0",
              )}
            >
              <DialogTitle as="h1" className="text-3xl font-semibold">
                {title}
              </DialogTitle>
